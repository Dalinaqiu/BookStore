<%@ Page Language="C#" MasterPageFile="~/Master/Admin.master" AutoEventWireup="true" CodeFile="BookAdd.aspx.cs" Inherits="Admin_BookAdd" Title="DreamStar平台 图书添加" validateRequest="false"%>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <asp:Button ID="btnaddHot" runat="server" Text="添加到推荐" OnClick="btnaddHot_Click" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </td>
        </tr>
    </table>
