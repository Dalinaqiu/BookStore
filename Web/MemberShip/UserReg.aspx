<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserReg.aspx.cs" Inherits="MemberShip_UserReg" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>DreamStar平台|用户注册</title>
</head>
<body>
  ...
  <tr>
    ...
    <td><div align="center">
      <table height="61" cellpadding="0" cellspacing="0">
        <tr>
          <td height="33" colspan="2"><p class="STYLE2">注册新帐户方便又容易</p></td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="2" align="center" style="height: 24px"><asp:ImageButton id="btnRegister" onclick="btnSubmit_Click" runat="server" ImageUrl="../Images/az-finish.gif"></asp:ImageButton></td>           
        </tr>
      </table>
